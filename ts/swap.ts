...
export class SwapContract extends BaseContract {
    ...
    signature
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                self.swap2.estimateGasAsync.bind(
                    self,
                    order,
                    signature
                ),
        ...
        awaitTransactionSuccessAsync(
            ...
            //
            const self = this as any as SwapContract;
            const txHashPromise = self.swap2.sendTransactionAsync(order,
    signature
    , txData);
            return new PromiseWithTransactionHash<TransactionReceiptWithDecodedLogs>(
                txHashPromise,
    ...
    public swap1 = {
        async sendTransactionAsync(
            ...
            const self = this as any as SwapContract;
            const encodedData = self._strictEncodeArguments('swap(uint256,address,uint256,address,address,uint256,address,uint256,bytes32,bytes32,uint8)', [id,
    makerWallet,
    makerParam,
    makerToken,
    takerWallet,
    ...
    v
            ...
            const txDataWithDefaults = await BaseContract._applyDefaultsToTxDataAsync(
                ...
                self._web3Wrapper.getContractDefaults(),
                self.swap1.estimateGasAsync.bind(
                    self,
                    id,
                    makerWallet,
                    makerParam,
        ...
        awaitTransactionSuccessAsync(
            ...
            //
            const self = this as any as SwapContract;
            const txHashPromise = self.swap1.sendTransactionAsync(id,
    makerWallet,
    makerParam,
    makerToken,
    takerWallet,
    ...
    v
        ...
        getABIEncodedTransactionData(
            ...
            const self = this as any as SwapContract;
            const abiEncodedTransactionData = self._strictEncodeArguments('swap(uint256,address,uint256,address,address,uint256,address,uint256,bytes32,bytes32,uint8)', [id,
    makerWallet,
    makerParam,
    makerToken,
    takerWallet,
    ...
    v
        ...
        v
            ...
            const rawCallResult = await self._web3Wrapper.callAsync(callDataWithDefaults, defaultBlock);
            BaseContract._throwIfRevertWithReasonCallResult(rawCallResult);
            const abiEncoder = self._lookupAbiEncoder('swap(uint256,address,uint256,address,address,uint256,address,uint256,bytes32,bytes32,uint8)');
            // tslint:disable boolean-naming
            const result = abiEncoder.strictDecodeReturnValue<void
        >(rawCallResult);
            // tslint:enable boolean-naming
